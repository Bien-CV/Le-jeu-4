...
\begin{DoxyCompactList}\small\item\em Prend en paramètre le joueur courant et vérifie si tous ses personnages ne sont pas morts. \end{DoxyCompactList}\item 
int \hyperlink{_minimale_8c_a0255b1b3f70d1d35a858e9e512c8f988}{calcul\-\_\-persos\-\_\-\-I\-A} (int joueur\-\_\-courant)
\begin{DoxyCompactList}\small\item\em Calcule le nombre de personnage controlé par l'I\-A. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Sauvegarde la partie en cours dans un fichier. \end{DoxyCompactList}\item 
int \hyperlink{_minimale_8c_a841458aecfd962618c6b89231954f407}{Charger} (int joueur\-\_\-courant)
\begin{DoxyCompactList}\small\item\em Permet de charger une partie depuis un fichier de sauvegarde. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Déplace le personnage sur le terrain Remplace la case où se trouvait le perso par une case terrain, et place le perso sur la 'case\-\_\-perso'. Si la 'case\-\_\-perso' contenait un piège, le perso perd des H\-P. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Permet au joueur de choisir la destination Le joueur déplace un curseur qui représente son joueur courant, il est limité aux limites du plateau et au nombre de déplacements qu'il possède. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Calcule les positions d'attaques valides, les met dans la liste. une case vide peut être attaquée. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Choisi parmi la liste des cases à attaquer pour l'I\-A, une case vide peut être attaquée. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Cette fonction permet au joueur de choisir un de ses persos sur le plateau grâce à un curseur. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Fonction de déroulement d'un tour pour le joueur entré en paramètre. \end{DoxyCompactList}\item 
int \hyperlink{_minimale_8c_aa6bc2b819d20d08ea1c98f09c15f2c47}{all\-\_\-dead\-\_\-but\-\_\-one} (int nb\-\_\-joueurs)
\begin{DoxyCompactList}\small\item\em Fonction déterminant si un seul joueur est vivant. Appellé par la fonction principale pour déterminer si c'est la fin de la partie. Renvoie 0 si plus d'un joueur survit, sinon renvoie 1. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Création brève de perso. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Créé un personnage du camp neutre à une position aléatoire sur le terrain. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Permet la création d'un personnage joueur à la position entrée. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Fonction de déroulement d'un tour pour l'I\-A. \end{DoxyCompactList}\item 
...
Code principal. \begin{DoxyAuthor}{Auteur}
...
Calcule le nombre de personnage controlé par l'I\-A. 
...
Choisi parmi la liste des cases à attaquer pour l'I\-A, une case vide peut être attaquée. 
...
Déplace le personnage sur le terrain Remplace la case où se trouvait le perso par une case terrain, et place le perso sur la 'case\-\_\-perso'. Si la 'case\-\_\-perso' contenait un piège, le perso perd des H\-P. 
...
Fonction de déroulement d'un tour pour l'I\-A. 
